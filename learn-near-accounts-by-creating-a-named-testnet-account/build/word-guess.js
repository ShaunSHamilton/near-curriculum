...
let WordGuess = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = call({
  privateFunction: true
}), _dec4 = call({
  privateFunction: true
}), _dec5 = view(), _dec6 = view(), _dec7 = call({}), _dec8 = view(), _dec(_class = (_class2 = class WordGuess {
  constructor() {
    this.secretWord = '';
  ...
  init({
    ...
    this.contractCreator = predecessorAccountId();
  ...
  makeGuess({
    ...
    if (lastGuess?.guess === this.secretWord) {
      ...
      const guesser = predecessorAccountId();
      log(`\nguesser = ${guesser}`);
      log(`\nguess = ${guess}`);
      this.guesses.push({
        guesser,
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewSecretWord", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "viewSecretWord"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addHint", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "addHint"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewHints", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "viewHints"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewGuesses", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "viewGuesses"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "makeGuess", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "makeGuess"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewContractCreator", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "viewContractCreator"), _class2.prototype)), _class2)) || _class);
function viewContractCreator() {
  const _state = WordGuess._getState();
  if (!_state && WordGuess._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = WordGuess._create();
  if (_state) {
    WordGuess._reconstruct(_contract, _state);
  }
  const _args = WordGuess._getArgs();
  const _result = _contract.viewContractCreator(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WordGuess._serialize(_result, true));
}
function makeGuess() {
  const _state = WordGuess._getState();
  if (!_state && WordGuess._requireInit()) {
  ...
  const _args = WordGuess._getArgs();
  const _result = _contract.makeGuess(_args);
  WordGuess._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WordGuess._serialize(_result, true));
}
function viewGuesses() {
  ...
  const _args = WordGuess._getArgs();
  const _result = _contract.viewGuesses(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WordGuess._serialize(_result, true));
}
function viewHints() {
  const _state = WordGuess._getState();
  ...
  const _args = WordGuess._getArgs();
  const _result = _contract.viewHints(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WordGuess._serialize(_result, true));
}
function addHint() {
  const _state = WordGuess._getState();
  ...
  const _args = WordGuess._getArgs();
  const _result = _contract.addHint(_args);
  WordGuess._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WordGuess._serialize(_result, true));
}
function viewSecretWord() {
  ...
  const _args = WordGuess._getArgs();
  const _result = _contract.viewSecretWord(_args);
  WordGuess._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WordGuess._serialize(_result, true));
}
function init() {
...
export { WordGuess, addHint, init, makeGuess, viewContractCreator, viewGuesses, viewHints, viewSecretWord };
//# sourceMappingURL=word-guess.js.map

...
let SentenceMaker = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = call({
  privateFunction: true
}), _dec(_class = (_class2 = class SentenceMaker {
  constructor() {
    this.sentence = '';
  ...
  viewWords() {
    // near.log(this.authors);
    return this.authors.toArray();
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addWord", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "addWord"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewSentence", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "viewSentence"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewWords", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "viewWords"), _class2.prototype)), _class2)) || _class);
function viewWords() {
  const _state = SentenceMaker._getState();
  if (!_state && SentenceMaker._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = SentenceMaker._create();
  if (_state) {
    SentenceMaker._reconstruct(_contract, _state);
  }
  const _args = SentenceMaker._getArgs();
  const _result = _contract.viewWords(_args);
  SentenceMaker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SentenceMaker._serialize(_result, true));
}
function viewSentence() {
  ...
  const _args = SentenceMaker._getArgs();
  const _result = _contract.viewSentence(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SentenceMaker._serialize(_result, true));
}
function addWord() {
  const _state = SentenceMaker._getState();
  ...
  const _args = SentenceMaker._getArgs();
  const _result = _contract.addWord(_args);
  SentenceMaker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SentenceMaker._serialize(_result, true));
}
function init() {
...
export { SentenceMaker, addWord, init, viewSentence, viewWords };
//# sourceMappingURL=sentence-maker.js.map
